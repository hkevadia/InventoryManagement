					...
					<form:form action="TaskDETCreationSave" method="post"
						...
						<div class="table-responsive">
							<table class="" width="100%" cellspacing="0">
								<tr>
									<td><label for="taskdate">Task Date</label></td>
									<td><form:input path="taskdate" id="taskdate"
											name="taskdate" type="text" placeholder="DD/MM/YYYY" /></td>
								</tr>

								<tr>
									<td><label for="tasknataskeoddescriptionme">Task EOD Description</label></td>
									<td><form:input path="taskeoddescription" id="taskeoddescription" type="text" /></td>
								</tr>
								<tr>
									<td><label for="taskgoaldescription">Task Goal Description</label></td>
									<td><form:input path="taskgoaldescription"
											id="taskgoaldescription" type="text" /></td>
								</tr>
								
								<tr>
									<td><label for="taskgoalcompletion">Task Completion in % </label></td>
									<td><form:input path="taskgoalcompletion"
											id="taskgoalcompletion" type="text" /></td>
								</tr>
